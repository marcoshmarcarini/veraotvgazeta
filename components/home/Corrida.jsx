...
const btnCorridaRes = {display:'flex',backgroundColor: '#00b893',color:'#ffffff',fontWeight: '500',padding: '10px',borderRadius: '50px',textDecoration: 'none',marginBottom: '20px',fontSize: '1.2rem'}
